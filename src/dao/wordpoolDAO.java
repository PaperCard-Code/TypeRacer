...
public class wordpoolDAO {
    ...
    public boolean addWord(WordPool wp) {
        ...
        String sql =
        "INSERT INTO wordpool(word,category) VALUES(?,?)";
    ...
    public boolean updateWord(WordPool wp,
                              String oldWord) {

        String sql =
        "UPDATE wordpool SET word=?,category=? WHERE word=?";
    ...
    public boolean deleteWord(String word) {
        ...
        String sql =
                "DELETE FROM wordpool WHERE word=?";
    ...
    public ArrayList<String> getWordsByCategory(
            String category) {
        ...
        String sql =
                "SELECT word FROM wordpool WHERE category=?";
