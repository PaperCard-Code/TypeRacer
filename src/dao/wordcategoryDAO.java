...
public class wordcategoryDAO {
    ...
    public boolean addCategory(WordCategory wc) {
        ...
        String sql =
        "INSERT INTO wordcategories(wordcategory,rarity)"
        + " VALUES(?,?)";
    ...
    public ArrayList<WordCategory> getAllCategories() {
        ...
        ArrayList<WordCategory> list =
                new ArrayList<>();

        String sql =
                "SELECT * FROM wordcategories";
    ...
    public boolean updateCategory(WordCategory wc) {
        ...
        String sql =
        "UPDATE wordcategories SET rarity=? WHERE wordcategory=?";
    ...
    public boolean deleteCategory(String category) {
        ...
        String sql =
                "DELETE FROM wordcategories WHERE wordcategory=?";
